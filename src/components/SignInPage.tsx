...
export default function SignInPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden flex items-center justify-center">
      {/* Background Effects */}
      ...
      <div className="relative z-10 max-w-md mx-auto px-6">
        ...
        <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl shadow-2xl p-8 text-center">
          ...
          {/* Title */}
          <h1 className="text-4xl font-black bg-gradient-to-r from-white via-purple-200 to-blue-200 bg-clip-text text-transparent mb-4 tracking-tight">
            AI Image Studio
          </h1>
          ...
          <button
            ...
            className="group relative w-full bg-white hover:bg-gray-50 text-gray-800 font-bold py-4 px-8 rounded-2xl transition-all duration-300 transform hover:scale-105 hover:shadow-2xl overflow-hidden"
          >
